...
<div class="min-h-full">
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="relative ml-3">
                ...
                <!--
                  Dropdown menu, show/hide based on menu city.
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">cities</h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Create State Form -->
        <form id="createForm" method="POST" action="{{ url('city') }}">
            @csrf
            ...
            <button type="button" onclick="submitForm('createForm')" class="mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Add City</button>
        </form>
      ...
      <table class="min-w-full bg-white shadow-md rounded-xl">
        ...
        @foreach ($cities as $city)
          <tr class="border-b border-blue-gray-200">
            ...
            <td class="py-3 px-4">{{ $city->city }}</td>
            <td class="py-3 px-4">
                <a href="{{ url('city/' . $city->id) }}" class="font-medium text-blue-600 hover:text-blue-800">Edit</a>
            </td>
            <td class="py-3 px-4">
            ...
            <td class="py-3 px-4">
                <a href="{{ url('pincodes/' . $city->id) }}" class="font-medium text-blue-600 hover:text-blue-800">show pincodes</a>
            </td>
          </tr>
        @endforeach
        </tbody>
