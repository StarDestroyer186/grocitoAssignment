...
<div class="min-h-full">
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">States</h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">

        <form method="POST" action="{{ url('state/'.$state->id) }}">
            @csrf
            @method('PUT')
        <label for="name">State</label>
        <input type="text" id="name" name="name" value="{{ $state->state }}">
